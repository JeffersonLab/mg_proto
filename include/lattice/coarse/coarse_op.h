...
namespace MG {
	...
	class CoarseDiracOp : public AuxiliarySpinors<CoarseSpinor> {
		public:
			...
			void unprecOp(CoarseSpinor& y,
					const CoarseGauge& gauge,
					const CoarseSpinor& x,
			...
			void M_AD_xpayz(CoarseSpinor& y,
					const float alpha,
					const CoarseGauge& gauge,
					const CoarseSpinor& z,
					const CoarseSpinor& x,
					const IndexType target_cb,
					const IndexType dagger,
					const IndexType tid) const;
			...
			void M_DA_xpayz(CoarseSpinor& y,
					const float alpha,
					const CoarseGauge& gauge,
					const CoarseSpinor& z,
					const CoarseSpinor& x,
			...
			void L_matrix(CoarseSpinor& y,
					const CoarseGauge& gauge,
					const CoarseSpinor& x) const
			{
...
#pragma omp parallel
			...
			void L_inv_matrix(CoarseSpinor& y,
					const CoarseGauge& gauge,
					const CoarseSpinor& x) const
			{
...
#pragma omp parallel
			...
			void R_inv_matrix(CoarseSpinor& y,
					const CoarseGauge& gauge,
					const CoarseSpinor& x) const {
...
#pragma omp barrier
			...
			inline IndexType GetNumColorSpin() const {
				return _n_colorspin;
			}

			inline IndexType GetNumColor() const {
				return _n_color;
			}

			inline IndexType GetNumSpin() const {
				return _n_spin;
			}

			inline SpinorHaloCB& GetSpinorHalo() {
				return _halo;
			}

			inline const SpinorHaloCB& GetSpinorHalo() const {
				return _halo;
			}
