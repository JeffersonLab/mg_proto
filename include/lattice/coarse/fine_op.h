...
#ifndef INCLUDE_LATTICE_COARSE_FINE_OP_H_
#define INCLUDE_LATTICE_COARSE_FINE_OP_H_
...
class FineDiracOp {
public:
	FineDiracOp(const LatticeInfo& l_info, IndexType n_smt = 1);
...
private:
	...
	int _n_threads;	ThreadLimits* _thread_limits;
