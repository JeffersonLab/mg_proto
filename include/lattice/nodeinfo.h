...
namespace MG {
	 ...
	 */
        ...
        /* Public methods */
        inline IndexType NumNodes() const { return _num_nodes; }

        inline IndexType NodeID() const { return _node_id; }

        inline const IndexArray &NodeDims() const { return _node_dims; }

        inline const IndexArray &NodeCoords() const { return _node_coords; }
