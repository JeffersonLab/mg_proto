...
namespace MG {
    ...
    {
    public:
        static std::vector<VCycleParams>
        hackVcycle(const std::vector<VCycleParams> &vcycle_params0) {
            ...
            for (int coarse_idx = n_levels - 2; coarse_idx >= 0; --coarse_idx) {
                ...
                if (coarse_idx == n_levels - 2) {
                    ...
                    MasterLog(INFO,
                              ...
                              coarse_idx + 1, coarse_idx + 2, coarse_idx + 1);
                    _coarse_vcycle[coarse_idx] = std::make_shared<Coarse2CoarseVCycleT>(
                        ...
                        (*(_coarse_presmoother[coarse_idx])), (*(_coarse_postsmoother[coarse_idx])),
