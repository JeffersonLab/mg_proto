...
namespace MG {
    ...
    public:
        ...
        MGDeflation(const std::shared_ptr<LatticeInfo> info,
        ...
        void apply(QPhiXSpinor &out, const QPhiXSpinor &in, bool do_VVA = true,
                   bool apply_A = true) const {
        ...
        void apply(QPhiXSpinorF &out, const QPhiXSpinorF &in_f, bool do_VVA = true,
                   bool apply_A = true) const {
