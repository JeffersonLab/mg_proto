...
FORCE_INLINE __m512 _mm512_set_ps(float e15, float e14, float e13, float e12,
                                  float e11, float e10, float e9, float e8,
...
* reference:
* https://github.com/simd-everywhere/simde/blob/master/simde/x86/sse.h
*/
#define _mm512_shuffle_ps(a, b, imm8)                                          \
  (({                                                                          \
    __m512 res;                                                                \
    res.vf32[0] = vmovq_n_f32(vgetq_lane_f32(a.vf32[0], (imm8) & (0x3)));      \
    res.vf32[0] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(a.vf32[0], ((imm8) >> 2) & 0x3), res.vf32[0], 1);       \
    res.vf32[0] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(b.vf32[0], ((imm8) >> 4) & 0x3), res.vf32[0], 2);       \
    res.vf32[0] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(b.vf32[0], ((imm8) >> 6) & 0x3), res.vf32[0], 3);       \
                                                                               \
    res.vf32[1] = vmovq_n_f32(vgetq_lane_f32(a.vf32[1], (imm8) & (0x3)));      \
    res.vf32[1] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(a.vf32[1], ((imm8) >> 2) & 0x3), res.vf32[1], 1);       \
    res.vf32[1] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(b.vf32[1], ((imm8) >> 4) & 0x3), res.vf32[1], 2);       \
    res.vf32[1] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(b.vf32[1], ((imm8) >> 6) & 0x3), res.vf32[1], 3);       \
                                                                               \
    res.vf32[2] = vmovq_n_f32(vgetq_lane_f32(a.vf32[2], (imm8) & (0x3)));      \
    res.vf32[2] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(a.vf32[2], ((imm8) >> 2) & 0x3), res.vf32[2], 1);       \
    res.vf32[2] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(b.vf32[2], ((imm8) >> 4) & 0x3), res.vf32[2], 2);       \
    res.vf32[2] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(b.vf32[2], ((imm8) >> 6) & 0x3), res.vf32[2], 3);       \
                                                                               \
    res.vf32[3] = vmovq_n_f32(vgetq_lane_f32(a.vf32[3], (imm8) & (0x3)));      \
    res.vf32[3] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(a.vf32[3], ((imm8) >> 2) & 0x3), res.vf32[3], 1);       \
    res.vf32[3] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(b.vf32[3], ((imm8) >> 4) & 0x3), res.vf32[3], 2);       \
    res.vf32[3] = vsetq_lane_f32(                                              \
        vgetq_lane_f32(b.vf32[3], ((imm8) >> 6) & 0x3), res.vf32[3], 3);       \
    res;                                                                       \
  }))
